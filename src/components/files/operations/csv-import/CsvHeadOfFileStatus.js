...
import CsvHeadOfFileContent from './CsvHeadOfFileContent'
import { LanguageContext } from '../../../../context/AppContext'

function CsvHeadOfFileStatus ({ file, transactionId }) {
  ...
  return (
    <>
      ...
      {ready && !loading && !error && !statusError && <CsvHeadOfFileContent file={file} />}
...
export default CsvHeadOfFileStatus
